// This code is for the Atlas Scientific wifi pool kit that was adapted to use esp32 as its computer.
...
const long myChannelNumber = 3038663;                            //Your Thingspeak channel number
